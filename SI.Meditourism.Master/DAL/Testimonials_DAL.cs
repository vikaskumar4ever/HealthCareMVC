...
{
    public class Testimonials_DAL : ITestimonialsRepository
    {
        ILog log = log4net.LogManager.GetLogger(typeof(Testimonials_DAL));
        ...
        public List<Testimonials> GetAllRecorod()
        {
            ...
            try
            {
                ...
                {
                    objReturn = db.Query<Testimonials>("udp_Testimonials_lst", commandType: System.Data.CommandType.StoredProcedure).ToList();
                }
            }
            catch (Exception ex)
        ...
        public TestimonialsPage GetRecordsPage(int iPageNo, int iPageSize)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    ...
                    objReturn.Testimonialss = db.Query<Testimonials>("udp_Testimonials_lstpage", param, commandType: System.Data.CommandType.StoredProcedure).ToList();
        ...
        public Testimonials GetRecorodById(Guid iId)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    DynamicParameters param = new DynamicParameters();
                    param.Add("@Id", iId);
                    objReturn = db.Query<Testimonials>("udp_Testimonials_sel", param: param, commandType: System.Data.CommandType.StoredProcedure).SingleOrDefault();
                }
            }
            catch (Exception ex)
        ...
        public Guid? InsertUpdateRecord(Testimonials objTestimonials)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    objReturn = db.Query<Guid>("udp_Testimonials_ups", param: objTestimonials, commandType: System.Data.CommandType.StoredProcedure).Single();
                }
            }
            catch (Exception ex)
        ...
        public bool DeleteRecord(int iId)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    DynamicParameters param = new DynamicParameters();
                    param.Add("@Id", iId);
                    db.Query("udp_Testimonials_del", param: param, commandType: System.Data.CommandType.StoredProcedure);
                    objReturn = true;
                }
            }
            catch (Exception ex)
