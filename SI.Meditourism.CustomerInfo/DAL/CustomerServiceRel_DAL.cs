...
{
    class CustomerServiceRel_DAL : ICustomerServiceRelRepository
    {
        ILog log = log4net.LogManager.GetLogger(typeof(CustomerServiceRel_DAL));
        ...
        public List<CustomerServiceRel> GetAllRecorod()
        {
            ...
            try
            {
                ...
                {
                    objReturn = db.Query<CustomerServiceRel>("udp_CustomerServiceRel_lst", commandType: System.Data.CommandType.StoredProcedure).ToList();
                }
            }
            catch (Exception ex)
        ...
        public CustomerServiceRelPage GetRecordsPage(int iPageNo, int iPageSize)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    ...
                    objReturn.CustomerServiceRels = db.Query<CustomerServiceRel>("udp_CustomerServiceRel_lstpage", param, commandType: System.Data.CommandType.StoredProcedure).ToList();
        ...
        public CustomerServiceRel GetRecorodById(Guid iId)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    DynamicParameters param = new DynamicParameters();
                    param.Add("@Id", iId);
                    objReturn = db.Query<CustomerServiceRel>("udp_CustomerServiceRel_sel", param: param, commandType: System.Data.CommandType.StoredProcedure).SingleOrDefault();
                }
            }
            catch (Exception ex)
        ...
        public Guid? InsertUpdateRecord(CustomerServiceRel objCustomerServiceRel)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    objReturn = db.Query<Guid>("udp_CustomerServiceRel_ups", param: objCustomerServiceRel, commandType: System.Data.CommandType.StoredProcedure).Single();
                }
            }
            catch (Exception ex)
        ...
        public bool DeleteRecord(int iId)
        {
            ...
            try
            {
                using (SqlConnection db = new SqlDBConnect().GetConnection())
                {
                    DynamicParameters param = new DynamicParameters();
                    param.Add("@Id", iId);
                    db.Query("udp_CustomerServiceRel_del", param: param, commandType: System.Data.CommandType.StoredProcedure);
                    objReturn = true;
                }
            }
            catch (Exception ex)
